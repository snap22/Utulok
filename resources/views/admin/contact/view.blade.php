      ...
      <div class="card-content">
        <div class="row">
          ...
          <div class="col s4">
            <div class="right-align ">
              <x-admin.controls.controls-all :editIcon="'done'" :editLink="route('contacts.solve', ['contactId' => $contact->contact_id])" :deleteLink="route('contacts.delete', ['contactId' => $contact->contact_id])" btnStyle="btn-flat btn-large white" />
            </div>
          </div>
        </div> <!-- row  -->
        ...
        <div class="card-content ">
          <div class="card-title">
            <h4><b> {{ $contact->contact_title }} </b> </h4>
          </div>
